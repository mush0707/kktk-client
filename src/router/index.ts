...
const routes: RouteRecordRaw[] = [
    ...
    {path: '/purchasing', component: () => import('@/views/purchasing/Purchasing.vue'), meta: {auth: true, can: 'purchasing.orders.view'}},
    {path: '/purchasing/partners', component: () => import('@/views/purchasing/partners/Partners.vue'), meta: {auth: true, can: 'partners.view.any'}},
    ...
    {path: '/accounting/invoices', component: () => import('@/views/accounting/Invoice.vue'), meta: {auth: true, can: 'accounting.invoices.show'}},
    {path: '/accounting/invoices/:id', component: () => import('@/views/accounting/InvoiceDetails.vue'), meta: {auth: true, can: 'accounting.invoices.show'}},
    {path: '/storages/cells/:id', component: () => import('@/views/storages/StorageMixedGarbageCell.vue'), meta: {auth: true, can: 'storage.mixed_garbage.view'}},
    ...
    {path: '/storages/:id/manufacturing', component: () => import('@/views/storages/mfg/Manufacturing.vue'), meta: {auth: true, can: 'storage.manufacturing.manage'}},
    ...
    {path: '/interview/stages', component: () => import('@/views/interview_stage/InterviewStage.vue'), meta: {auth: true, can: 'hr.interview_stages.view'}},
    {path: '/accounting', component: () => import('@/views/accounting/Accounting.vue'), meta: {auth: true, can: 'accounting.payrolls.view'}},
    {path: '/hr/role-positions', component: () => import('@/views/hr/RolePosition.vue'), meta: {auth: true, can: 'hr.role_positions.view'}},
    {path: '/hr/vacancy', component: () => import('@/views/hr/Vacancy.vue'), meta: {auth: true, can: 'hr.vacancies.view'}},
    {path: '/hr/candidates', component: () => import('@/views/hr/Candidates.vue'), meta: {auth: true, can: 'hr.candidates.view'}},
    {path: '/hr', component: () => import('@/views/hr/Hr.vue'), meta: {auth: true, can: 'hr.candidates.view'}},

    {path: '/hr/employees/', component: () => import('@/views/hr/EmployeesIndex.vue'), meta: {auth: true, can: 'hr.employees.view'}},
    {path: '/hr/calendar-and-holidays', component: () => import('@/views/hr/CalendarAndHolidays.vue'), meta: {auth: true}},
    {path: '/hr/employees/:id/manage', component: () => import('@/views/hr/EmployeeManage.vue'), meta: {auth: true, can: 'hr.employees.view'}},
    ...
    {path: '/hr/leave-requests', component: () => import('@/views/hr/Leave/LeaveRequests.vue'), meta: {auth: true}},
    {path: '/requests/hr/leave-requests', component: () => import('@/views/hr/Leave/MyLeaveRequests.vue'), meta: {auth: true}},
    {path: '/requests/hr', component: () => import('@/views/requests/hr/Hr.vue'), meta: {auth: true}},
    {path: '/payroll/settings', component: () => import('@/views/PayrollSettings.vue'), meta: {auth: true, can: 'hr.manage'}},
    {path: '/payrolls', component: () => import('@/views/accounting/Payroll.vue'), meta: {auth: true, can: 'accounting.payrolls.view'}},
    {
        path: '/sales',
        name: 'sales',
        component: () => import('@/views/sales/Sale.vue'),
        meta: { auth: true, title: 'Վաճառքների ստորաբաժանում' },
    },
    {
        path: '/sales/discounts',
        name: 'sales.discounts',
        component: () => import('@/views/sales/DiscountsManage.vue'),
        meta: { auth: true, can: 'sales.discounts.view', title: 'Զեղչերի կառավարում' },
    },
    {
        path: '/sales/pricing-policy',
        name: 'sales.pricing',
        component: () => import('@/views/sales/PricingPolicy.vue'),
        meta: { auth: true, can: 'sales.products.portions.view', title: 'Գնային քաղաքականություն' },
    },
    {
        path: '/sales/cash-registers',
        name: 'sales.cash-registers',
        component: () => import('@/views/sales/CashRegisters.vue'),
        meta: { auth: true, can: 'sales.cash_registers.view', title: 'Դրամարկղեր' },
    },
    {
        path: '/sales/sale',
        name: 'sales.sale',
        component: () => import('@/views/sales/CashRegisterSale.vue'),
        meta: { auth: true, title: 'Դրամարկղ' },
    },
    {
        path: '/storages/:id/quick-sales',
        name: 'storages.quick-sales',
        component: () => import('@/views/storages/StorageQuickSale.vue'),
        meta: { auth: true, can: 'storages.quick_sales.view', title: 'Արագ վաճառքներ' },
    },
]
