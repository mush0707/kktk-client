<template>
  <div class="flex flex-col">
    ...
    <!-- Body -->
    <ApplicationList v-if="tab==='list'" />
    <NewApplication v-else />
  </div>
</template>
...
import NewApplication from './components/application/AddEditApplication.vue'

const tab = ref<'list'|'new'>('list')

const tabBtnClass = (k:'list'|'new') =>
